...
maxInt :: Tree -> Int
maxInt (Leaf i)     = i
maxInt (Node m l r) = maximum [m, maxInt l, maxInt r]
...
minInt :: Tree -> Int
minInt (Leaf i)     = i
minInt (Node m l r) = minimum [m, minInt l, minInt r]
...
isBST :: Tree -> Bool
isBST (Leaf i)     = True
isBST (Node m l r) = (inorder l < [m]) && (inorder r > [m])
...
--   
inBST :: Int -> Tree -> Bool
inBST n (Leaf i)     = [n] == inorder (Leaf i)
inBST n (Node m l r) = n `elem` inorder (Node m l r)
